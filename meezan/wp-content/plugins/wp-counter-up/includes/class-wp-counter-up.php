...
class Wp_Counter_Up {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action('init', $plugin_admin, 'lgx_milestone_post_type');

        //adding the setting action
        $this->loader->add_action('admin_init', $plugin_admin, 'wp_conter_up_setting_init');
        ...
        //portfolio save post
        $this->loader->add_action('save_post', $plugin_admin, 'save_post_metabox_lgx_milestone', 10, 2);
	...
	private function define_public_hooks() {
        ...
        //Add  Short Code
        add_shortcode('lgx-counter', array($plugin_public, 'lgx_milestone_shortcode_function' ));
